 ...
 * @author Usuario
 */
public class debitoControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cuenta = request.getParameter("txtCuenta"); //a debitar
        ...
        if(cuenta.equals("") || monto.equals("")){
            ...
            if(servicios.existCuenta(cuenta)){
                if(servicios.disponibilidadSaldo(cuenta, cantidad)){
                    if(servicios.pagoServicio(cuenta, temp.getCuenta(), cantidad)){
